  ...
  return (
    <div className="panel">
      ...
      <p style={{ margin: '0 0 0.75rem', fontSize: '0.875rem', color: 'var(--muted)' }}>
        Drag the button below to your bookmarks bar. On the Powerbuy deals page, click it once to start monitoring. A floating button will appear — save as many commitments as you want across tabs, then click it when you're ready to import.
      </p>
