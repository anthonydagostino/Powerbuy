...
public class ReceiptsController : ControllerBase
{
    ...
    public async Task<IActionResult> ProcessReceipt(ReceiptProcessRequest request)
    {
        ...
        foreach (var item in request.Items)
        {
            ...
            var currentQuantityPaid = purchase.QuantityPaid;
            var newQuantityPaid = currentQuantityPaid + item.Qty;
            ...
            if (purchase.PaymentStatus == "Not Paid")
            {
                if (purchase.Quantity == item.Qty && NearlyEqual(expectedSellPrice, item.Total))
                {
                    ...
                    results.Add(new { item.Upc, result = "Paid", purchase.Id });
                }
                ...
                else
                {
                    ...
                    results.Add(new { item.Upc, result = "Issue", purchase.Id });
                }
            }
